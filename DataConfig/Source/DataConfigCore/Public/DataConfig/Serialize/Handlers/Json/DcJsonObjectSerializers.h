...
DATACONFIGCORE_API FDcResult HandlerStringSoftObjectSerialize(FDcSerializeContext& Ctx);
DATACONFIGCORE_API FDcResult HandlerStringLazyObjectSerialize(FDcSerializeContext& Ctx);
DATACONFIGCORE_API FDcResult HandlerStringSoftClassSerialize(FDcSerializeContext& Ctx);
