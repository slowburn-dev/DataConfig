...
DC_TEST("DataConfig.Core.JSON.ReaderFloats")
{
	...
	// ref: https://github.com/nlohmann/json/blob/develop/test/src/unit-testsuites.cpp
	{
		...
		UTEST_OK("JsonReader Coercion float", _TestFloat("-0.0", 0.0f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1.0", 1.0f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1.0", -1.0f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1.5", 1.5f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1.5", -1.5f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("3.1416", 3.1416f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1E10", 1E10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1e10", 1e10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1E+10", 1E+10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1E-10", 1E-10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1E10", -1E10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1e10", -1e10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1E+10", -1E+10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("-1E-10", -1E-10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1.234E+10", 1.234E+10f));
		UTEST_OK("JsonReader Coercion float", _TestFloat("1.234E-10", 1.234E-10f));
